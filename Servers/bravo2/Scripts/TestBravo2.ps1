...
#How to use: ./TestBravo2.ps1 -name 'ns2' -ipaddress '172.18.0.35' -defaultgateway '172.18.0.33' -ethernet 'Ethernet0)' 

#params
param([String]$name='ns2',
	[String]$ipaddress='172.18.0.35',
	[String]$defaultgateway='172.18.0.33',
